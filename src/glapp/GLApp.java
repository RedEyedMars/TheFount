 ...
 */
public class GLApp {
    public static float SMALL_NUM=0.0000001f;
    // Just for reference
     ...
     * handleEvents() calls:  mouseMove(), mouseLDown(), mouseLUp(), keyDown(), keyUp()
     */
    public void run() {
     ...
     * as mouseLDown() and mouseMove() to see which button is activated.
